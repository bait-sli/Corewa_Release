...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/17 14:44:25 by atgerard          #+#    #+#             */
/*   Updated: 2018/04/25 23:03:52 by atgerard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "corewar.h"

static void			or(t_process *ec, t_env *env)
{
	int			t[2];
	uint8_t		b[4];
	int			i;
