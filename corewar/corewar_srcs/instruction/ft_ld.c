...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/17 16:12:57 by acombe            #+#    #+#             */
/*   Updated: 2018/04/25 23:02:16 by atgerard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "corewar.h"

static void		ld(t_process *ec, t_env *env)
{
	uint8_t		b[4];
	int			addr;
	...
	{
		addr = ft_get_addr(ec->pc, ec->par.p[0], IDX_MOD);
