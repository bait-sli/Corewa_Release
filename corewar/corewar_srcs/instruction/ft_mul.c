...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/25 22:49:48 by atgerard          #+#    #+#             */
/*   Updated: 2018/04/25 22:50:14 by atgerard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "corewar.h"

static void		mul(t_process *ec, t_env *env)
{
	char *pref;
...
int				ft_mul(t_process *ec, t_env *env)
{
	uint8_t opcode;
